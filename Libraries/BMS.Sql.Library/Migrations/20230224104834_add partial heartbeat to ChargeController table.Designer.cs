...
namespace BMS.Sql.Library.Migrations
{
    ...
    [Migration("20230224104834_add partial heartbeat to ChargeController table")]
    partial class addpartialheartbeattoChargeControllertable
    {
            ...
            modelBuilder.Entity("BMS.Sql.Library.Models.ChargeController", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("PartialHeartbeat")
                        .HasColumnType("timestamp with time zone");
