...
namespace BMS.Sql.Library.Migrations
{
    ...
    [Migration("20221003133052_Modified_high_level_measuring_device_in_two_variables_to_better_reflect_how_the_value_is_calculated")]
    partial class Modified_high_level_measuring_device_in_two_variables_to_better_reflect_how_the_value_is_calculated
    {
            ...
            modelBuilder.Entity("BMS.Sql.Library.Models.ChargeController", b =>
                {
                    ...
                    b.Property<string>("MonitoredCpsNumber")
                        .HasColumnType("text");
