...
namespace BMS.Sql.Library.Migrations
{
    ...
    [Migration("20221031150013_add CurrentTagVersion and OsReleaseVersion fields to ChargeController table")]
    partial class addCurrentTagVersionandOsReleaseVersionfieldstoChargeControllertable
    {
            ...
            modelBuilder.Entity("BMS.Sql.Library.Models.ChargeController", b =>
                {
                    ...
                    b.Property<string>("CurrentTagVersion")
                        .HasColumnType("text");
