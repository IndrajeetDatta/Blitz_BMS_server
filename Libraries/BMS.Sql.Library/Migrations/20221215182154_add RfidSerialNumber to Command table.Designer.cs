...
namespace BMS.Sql.Library.Migrations
{
    ...
    [Migration("20221215182154_add RfidSerialNumber to Command table")]
    partial class addRfidSerialNumbertoCommandtable
    {
            ...
            modelBuilder.Entity("BMS.Sql.Library.Models.Transaction", b =>
                {
                    ...
                    b.Property<string>("ChargeTimeSec")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ConnectedTimeSec")
                        .HasColumnType("text");
