...
export class ChargeStationConfigurationComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.navigationBtns = [{text: this.configuration.serialNumber!}, {text: this.translate.instant("station-configuration.configure-station")}]
  ...
  async saveConfiguration(): Promise<void> {
    ...
    try {
      await this.commandService.postCommand(this.configuration.id, undefined, JSON.stringify(this.configuration), BMSWebApiClientModule.CommandType.ModemConfig)
      await this.commandService.postCommand(this.configuration.id, undefined, JSON.stringify(this.configuration), BMSWebApiClientModule.CommandType.NetworkConfig)
  ...
  navBtnClicked(valueEmitted: NavBtnType) {
    ...
    } else if (valueEmitted.text === this.translate.instant("station-configuration.configure-station")) {
