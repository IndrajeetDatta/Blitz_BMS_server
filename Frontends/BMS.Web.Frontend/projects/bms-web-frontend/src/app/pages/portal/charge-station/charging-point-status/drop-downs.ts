...
export const ddEnergyType: ddType = [
  ...
  {
    fetchValue: 'EEM357',
    displayedValue: 'Phoenix Contact EEM-EM357 / EEM-DM357',
  },
  { fetchValue: 'EEM357EE', displayedValue: 'Phoenix Contact EEM357EE' },
  {
    fetchValue: 'EEM_AM157_70',
    displayedValue: 'Phoenix Contact EEM-AM157-70',
  },
...
export const ddHighLvlCommunication: ddType = [
  {
    fetchValue: 'DISABLED',
    displayedValue: 'Disabled (No high-level communication.)',
  },
  {
    fetchValue: 'OPTIONAL',
    displayedValue: 'Optional (High-level communication only on EV request.)',
  },
  {
    fetchValue: 'REQUIRED',
    displayedValue: 'Required (Only high-level communication.)',
  },
];
