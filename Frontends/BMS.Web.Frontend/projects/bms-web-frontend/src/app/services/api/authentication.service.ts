...
export class AuthenticationService {
  ...
  public async authenticateBasic(appUser : BMSWebApiClientModule.AuthenticationBasicRequest): Promise<BMSWebApiClientModule.AuthenticationResponse> {
    const request = new BMSWebApiClientModule.AuthenticationBasicRequest(appUser);
