...
export module BMSWebApiClientModule {
  export class BMSWebApiClient {
     ...
     * @return OK
     */
    addAndRemoveAccessForInstallers(
      userEmail: string | undefined,
      externalId: string | undefined,
      body: ApplicationUser[][] | undefined,
      chargeControllerId: number
    ): Promise<void> {
      let url_ =
        this.baseUrl + '/charge-station/installers/{chargeControllerId}';
    ...
    protected processAddAndRemoveAccessForInstallers(
      response: Response
    ): Promise<void> {
      const status = response.status;
      let _headers: any = {};
    ...
    protected processGetAllInstallers(
      response: Response
    ): Promise<ApplicationUser[]> {
      const status = response.status;
      let _headers: any = {};
    ...
    protected processGetChargeStationLogFiles(
      response: Response
    ): Promise<Anonymous3> {
      const status = response.status;
      let _headers: any = {};
  ...
  export class ChargeController implements IChargeController {
    ...
    init(_data?: any) {
      if (_data) {
        ...
        this.fullHeartbeat = _data['fullHeartbeat']
          ? new Date(_data['fullHeartbeat'].toString())
          : <any>undefined;
        this.loadManagementIpAddress = _data['loadManagementIpAddress'];

        // this.voltageU1 = _data['voltageU1'];
        // this.voltageU2 = _data['voltageU2'];
        // this.voltageU3 = _data['voltageU3'];
        // this.totalEnergy = _data['totalEnergy'];
        // this.powerFactor = _data['powerFactor'];
    ...
    toJSON(data?: any) {
      ...
      data['fullHeartbeat'] = this.fullHeartbeat
        ? this.fullHeartbeat.toISOString()
        : <any>undefined;
      data['loadManagementIpAddress'] = this.loadManagementIpAddress;

      // data['voltageU1'] = this.voltageU1;
      // data['voltageU2'] = this.voltageU2;
      // data['voltageU3'] = this.voltageU3;
      // data['totalEnergy'] = this.totalEnergy;
      // data['powerFactor'] = this.powerFactor;
  ...
  export class ChargePoint implements IChargePoint {
    ...
    states?: string[];
    localBusState?: string;
    chargingDuration?: string;
    pluginDuration?: string;
    chargingCurrentLimit?: string;
    busPosition?: string;
    status?: string;
    errorStatus?: string;
    ...
    init(_data?: any) {
      if (_data) {
        ...
        this.localBusState = _data['localBusState'];
        this.chargingDuration = _data['chargingDuration'];
        this.pluginDuration = _data['pluginDuration'];
        this.chargingCurrentLimit = _data['chargingCurrentLimit'];
        this.busPosition = _data['busPosition'];

        this.status = _data['status'];
        this.errorStatus = _data['errorStatus'];
        this.externalTemperature = _data['externalTemperature'];
    ...
    toJSON(data?: any) {
      ...
      data['localBusState'] = this.localBusState;
      data['chargingDuration'] = this.chargingDuration;
      data['pluginDuration'] = this.pluginDuration;
      data['chargingCurrentLimit'] = this.chargingCurrentLimit;
      data['busPosition'] = this.busPosition;

      data['status'] = this.status;
      data['errorStatus'] = this.errorStatus;
      data['externalTemperature'] = this.externalTemperature;
  ...
  export class Rfid implements IRfid {
    ...
    toJSON(data?: any) {
      ...
      data['expiryDate'] = this.expiryDate
        ? this.expiryDate.toISOString().split('+')[0].replace('Z', '')
        : <any>undefined;
      data['type'] = this.type;
      return data;
    }
