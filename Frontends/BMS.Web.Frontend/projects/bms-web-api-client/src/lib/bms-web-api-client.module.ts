...
export class BMSWebApiClient {
     ...
     * @return OK
     */
    updateUsers(body: ApplicationUserUpdateRequest | undefined, userEmail: string, externalId: string): Promise<ApplicationUser> {
        let url_ = this.baseUrl + "/users";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    getChargeStationConfiguration(userEmail: string, externalId: string, id: number): Promise<ChargeController> {
    ...
    protected processGetChargeStationConfiguration(response: Response): Promise<ChargeController> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    updateChargeStationConfigurationId(body: ChargeController | undefined, userEmail: string, externalId: string, id: number): Promise<ChargeController> {
        let url_ = this.baseUrl + "/charge-station/configuration/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processUpdateChargeStationConfigurationId(response: Response): Promise<ChargeController> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    getInstallersForChargeStation(userEmail: string, externalId: string, chargeControllerId: number): Promise<ApplicationUser[]> {
     ...
     * @return OK
     */
    getChargeStationWhitelist(userEmail: string, externalId: string, id: number): Promise<ChargeController> {
    ...
    protected processGetChargeStationWhitelist(response: Response): Promise<ChargeController> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    getChargeStationTransaction(userEmail: string, getAllTransactions: boolean, externalId: string, id: number): Promise<ChargeController> {
        let url_ = this.baseUrl + "/charge-station/configuration/transaction/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        let options_: RequestInit = {
            ...
            headers: {
                "userEmail": userEmail !== undefined && userEmail !== null ? "" + userEmail : "",
                "getAllTransactions": getAllTransactions !== undefined && getAllTransactions !== null ? "" + getAllTransactions : "",
                "externalId": externalId !== undefined && externalId !== null ? "" + externalId : "",
                "Accept": "application/json"
            }
        };
    ...
    protected processGetChargeStationTransaction(response: Response): Promise<ChargeController> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    getChargeStationChargePoint(userEmail: string, externalId: string, id: number): Promise<ChargePoint> {
    ...
    protected processGetChargeStationChargePoint(response: Response): Promise<ChargePoint> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    updateChargeStationChargePointId(body: ChargePoint | undefined, id: number): Promise<ChargePoint> {
        let url_ = this.baseUrl + "/charge-station/charge-point/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processUpdateChargeStationChargePointId(response: Response): Promise<ChargePoint> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    getChargeStationsOverview(userEmail: string, externalId: string): Promise<ChargePoint[]> {
    ...
    protected processGetChargeStationsOverview(response: Response): Promise<ChargePoint[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    getChargeStationOcpp(userEmail: string, externalId: string, chargeControllerId: number): Promise<Anonymous> {
    ...
    protected processGetChargeStationOcpp(response: Response): Promise<Anonymous> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    updateChargeStationOcppConfig(body: OcppConfig | undefined, chargeControllerId: number): Promise<OcppConfig> {
        let url_ = this.baseUrl + "/charge-station/ocpp/{chargeControllerId}";
        if (chargeControllerId === undefined || chargeControllerId === null)
            throw new Error("The parameter 'chargeControllerId' must be defined.");
        url_ = url_.replace("{chargeControllerId}", encodeURIComponent("" + chargeControllerId));
    ...
    protected processUpdateChargeStationOcppConfig(response: Response): Promise<OcppConfig> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @param userEmail for login
     * @param externalId for login
     * @param chargeControllerId this is charge controller Id
     * @return OK
     */
    getOcppMessages(userEmail: string, externalId: string, chargeControllerId: number): Promise<OcppMessage[]> {
        let url_ = this.baseUrl + "/charge-station/ocpp/ocpp-messages/{chargeControllerId}";
        if (chargeControllerId === undefined || chargeControllerId === null)
            throw new Error("The parameter 'chargeControllerId' must be defined.");
        url_ = url_.replace("{chargeControllerId}", encodeURIComponent("" + chargeControllerId));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetOcppMessages(response: Response): Promise<OcppMessage[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    getChargeStationCommandHistory(userEmail: string, externalId: string, masterId: string, chargeControllerId: number): Promise<Anonymous2> {
        let url_ = this.baseUrl + "/charge-station/command-history/{masterId}/{chargeControllerId}";
    ...
    protected processGetChargeStationCommandHistory(response: Response): Promise<Anonymous2> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    postCommand(body: Command | undefined, userEmail: string, externalId: string): Promise<number> {
     ...
     * @return OK
     */
    getCommands(inPendingOrProcessingCommands: boolean | undefined, masterId: string | undefined): Promise<CommandHistory[]> {
        let url_ = this.baseUrl + "/command?";
        if (inPendingOrProcessingCommands === null)
            throw new Error("The parameter 'inPendingOrProcessingCommands' cannot be null.");
        else if (inPendingOrProcessingCommands !== undefined)
            url_ += "inPendingOrProcessingCommands=" + encodeURIComponent("" + inPendingOrProcessingCommands) + "&";
        if (masterId === null)
    ...
    protected processGetCommands(response: Response): Promise<CommandHistory[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    protected processAuthenticationBasic(response: Response): Promise<AuthenticationResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    getChargeStationEmails(userEmail: string | undefined, externalId: string | undefined, id: number): Promise<Email[]> {
    ...
    protected processGetChargeStationEmails(response: Response): Promise<Email[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class ApplicationUserUpdateRequest implements IApplicationUserUpdateRequest {
    id?: number;
    firstName?: string;
    lastName?: string;
    newPassword?: string;
...
export class ChargeController implements IChargeController {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.dateInstalled = _data["dateInstalled"] ? new Date(_data["dateInstalled"].toString()) : <any>undefined;
            this.lastMaintenance = _data["lastMaintenance"] ? new Date(_data["lastMaintenance"].toString()) : <any>undefined;
            this.systemTime = _data["systemTime"] ? new Date(_data["systemTime"].toString()) : <any>undefined;
            ...
            this.installer = _data["installer"] ? ApplicationUser.fromJS(_data["installer"]) : <any>undefined;
            ...
            this.varVolatileUtilizationPercentage = _data["varVolatileUtilizationPercentage"];
            ...
            this.ocppConfig = _data["ocppConfig"] ? OcppConfig.fromJS(_data["ocppConfig"]) : <any>undefined;
            ...
            this.highLevelMeasuringDeviceControllerId = _data["highLevelMeasuringDeviceControllerId"];
            this.highLevelMeasuringDeviceModbus = _data["highLevelMeasuringDeviceModbus"];
            ...
            this.userData = _data["userData"] ? UserData.fromJS(_data["userData"]) : <any>undefined;
    ...
    toJSON(data?: any) {
        ...
        data["dateInstalled"] = this.dateInstalled ? this.dateInstalled.toISOString() : <any>undefined;
        data["lastMaintenance"] = this.lastMaintenance ? this.lastMaintenance.toISOString() : <any>undefined;
        data["systemTime"] = this.systemTime ? this.systemTime.toISOString() : <any>undefined;
        ...
        data["installer"] = this.installer ? this.installer.toJSON() : <any>undefined;
        ...
        data["varVolatileUtilizationPercentage"] = this.varVolatileUtilizationPercentage;
        ...
        data["ocppConfig"] = this.ocppConfig ? this.ocppConfig.toJSON() : <any>undefined;
        ...
        data["highLevelMeasuringDeviceControllerId"] = this.highLevelMeasuringDeviceControllerId;
        data["highLevelMeasuringDeviceModbus"] = this.highLevelMeasuringDeviceModbus;
...
export class ChargePoint implements IChargePoint {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.chargeCurrentMinimumInAmpers = _data["chargeCurrentMinimumInAmpers"];
            this.chargeCurrentMaximumInAmpers = _data["chargeCurrentMaximumInAmpers"];
...
export class Rfid implements IRfid {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.evConsumptionRateKWhPer100KM = _data["evConsumptionRateKWhPer100KM"];
            this.name = _data["name"];
            this.serialNumber = _data["serialNumber"];
...
export class OcppStatus implements IOcppStatus {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.occpStatusSentDate = _data["occpStatusSentDate"] ? new Date(_data["occpStatusSentDate"].toString()) : <any>undefined;
    ...
    toJSON(data?: any) {
        ...
        data["occpStatusSentDate"] = this.occpStatusSentDate ? this.occpStatusSentDate.toISOString() : <any>undefined;
...
export class OcppMessage implements IOcppMessage {
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.ocpp = _data["ocpp"] ? ChargeController.fromJS(_data["ocpp"]) : <any>undefined;
...
export class AuthenticationBasicRequest implements IAuthenticationBasicRequest {
    email?: string;
    externalId?: string;
    role?: string;
    nickname?: string;
